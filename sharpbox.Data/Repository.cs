...
namespace sharpbox.Data
{
    public class Repository<T>
    {
        ...
        public T Create(Dispatch.Client dispatcher, T entity)
        {
            ...
            dispatcher.Broadcast(new Package() { EventName = EventNames.OnDataCreate, Message = "Entity created.", Entity = e, Type = this.GetType(), PackageId = 0, UserId = dispatcher.CurrentUserId });
            return e;
        }
        ...
        public T Get(Dispatch.Client dispatcher, int id)
        {
            ...
            dispatcher.Broadcast(new Package() { EventName = EventNames.OnDataCreate, Message = "Entity retrieved", Entity = e, Type = this.GetType(), PackageId = 0, UserId = dispatcher.CurrentUserId });
            return e;
        }
        ...
        public T Update(Dispatch.Client dispatcher, T entity)
        {
            ...
            dispatcher.Broadcast(new Package() { EventName = EventNames.OnDataCreate, Message = "Entity updated", Entity = e, Type = this.GetType(), PackageId = 0, UserId = dispatcher.CurrentUserId });
            return e;
        }
        ...
        public IEnumerable<T> UpdateAll(Dispatch.Client dispatcher, IEnumerable<T> entities)
        {
            ...
            dispatcher.Broadcast(new Package() { EventName = EventNames.OnDataCreate, Message = "All entities updated", Entity = e, Type = this.GetType(), PackageId = 0, UserId = dispatcher.CurrentUserId });
            return e;
        }
        ...
        public void Delete(Dispatch.Client dispatcher, T entity)
        {
            ...
            dispatcher.Broadcast(new Package() { EventName = EventNames.OnDataCreate, Message = "Entity deleted", Entity = entity, Type = this.GetType(), PackageId = 0, UserId = dispatcher.CurrentUserId });
        }
