...
namespace sharpbox.Notification
{
  ...
  public class NotificationContext
  {
    ...
    public void ProcessEvent(IResponse response)
    {
    ...
    public BackLogItem Notify(BackLogItem bli, IIdentityMessageService messageService)
    {
      ...
      if (!BackLog.Exists(x => x.BackLogItemId.Equals(bli.BackLogItemId)))
      {
        BackLog.Add(bli);
      }
      else
      {
        ...
        {
          if (BackLog[i].BackLogItemId != bli.BackLogItemId) continue;
