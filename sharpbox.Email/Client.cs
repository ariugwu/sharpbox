...
namespace sharpbox.Email
{
    public class Client
    {
        ...
        public void Send(Dispatch.Client dispatcher, SmtpClient smtpClient, List<string> to, string from, string subject, string body, List<string> cc, List<string> bcc, Dictionary<string, byte[]> attachments, bool isBodyHtml = true)
        {
