...
declare module sharpbox.Audit.Dispatch {
	...
	interface AuditEvents extends sharpbox.Dispatch.Model.EventName {
	}
}
declare module sharpbox.Dispatch.Model {
	interface EventName extends sharpbox.Util.Enum.EnumPattern {
		EventNameId: number;
		Name: string;
	...
	interface Request extends sharpbox.Dispatch.Model.BasePackage {
		...
		CommandName: sharpbox.Dispatch.Model.CommandName;
	...
	interface CommandName extends sharpbox.Util.Enum.EnumPattern {
		CommandNameId: number;
		Name: string;
		ApplicationId: System.Guid;
	}
	interface Response extends sharpbox.Dispatch.Model.BasePackage {
		...
		Message: string;
		EventNameId: number;
		EventName: sharpbox.Dispatch.Model.EventName;
		RequestId: number;
		RequestUniqueKey: System.Guid;
...
declare module sharpbox.Util.Enum {
...
declare module sharpbox.Membership.Model {
	interface UserRoleName extends sharpbox.Util.Enum.EnumPattern {
