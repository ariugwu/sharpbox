namespace sharpbox.Dispatch.Model
{
    ...
    public interface IDispatchContext
    {
        ...
        /// <summary>
        /// Gets a list of all of the registered Feedback objects by EnumPattern value.
        /// </summary>
        Dictionary<string, Feedback> FeedbackHub { get; set; }
        ...
        void Register<T>(QueryName queryName, Delegate action, Feedback feedback);
        ...
        void Register<T>(CommandName commandName, Func<T, T> action, EventName eventName, Feedback feedback);

        void Register<T>(CommandName commandName, Delegate action, EventName eventName, Feedback feedback);
        ...
        void Register<T>(RoutineName routineName, CommandName commandName, EventName eventName, Func<T, Feedback, T> action, Func<T, Feedback, T> failOver = null, Func<T, Feedback, T> rollBack = null);
        ...
        T RollBack<T>(RoutineName routineName, Feedback feedback, object[] args);
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        T Run<T>(RoutineName routineName, Feedback feedback, object[] args);
        ...
        T Fetch<T>(QueryName queryName, object[] args);
        ...
        /// <returns></returns>
        IResponse Process<T>(CommandName commandName, object[] args);
    }
}
